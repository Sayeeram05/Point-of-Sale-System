        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            ...
            if (constraints.maxWidth < 800) {
              return Column(
                children: [
                  Expanded(child: _buildSelectedMaterials()),
                  const SizedBox(height: 16),
                  Expanded(child: _buildAvailableMaterials()),
                ],
              );
            }
            // Desktop layout
            return Row(
              ...
              children: [
                Expanded(flex: 1, child: _buildSelectedMaterials()),
                const SizedBox(width: 24),
                Expanded(flex: 1, child: _buildAvailableMaterials()),
              ],
            );
          },
        ),
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                const SizedBox(width: 40, child: Text('S.No', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF6B7280)))),
                const Expanded(child: Text('Material Name', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF6B7280)))),
                const SizedBox(width: 60, child: Text('Qty', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF6B7280)))),
                const SizedBox(width: 70, child: Text('Price (₹)', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF6B7280)))),
                const SizedBox(width: 70, child: Text('Total (₹)', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Color(0xFF6B7280)))),
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildSelectedMaterialRow(index + 1, _selectedMaterials[index], index);
              },
            ),
          ),
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.remove, size: 12, color: Color(0xFF6B7280)),
                  ),
                ),
                Padding(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: const Icon(Icons.add, size: 12, color: Color(0xFF6B7280)),
                  ),
                ),
              ],
            ),
        ...
        children: [
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                return _buildAvailableMaterialRow(_availableMaterials[index]);
              },
            ),
          ),
