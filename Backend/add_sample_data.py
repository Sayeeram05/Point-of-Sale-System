#!/usr/bin/env python
"""
Add sample WOFL shop data to Django database
...
def add_sample_data():
    print("Adding sample WOFL shop data...")
    ...
    products_data = [
        # Classic WOFLs
        ("Belgian Classic", 120.00, "Classic WOFLs"),
        ("Butter Delight", 100.00, "Classic WOFLs"),
        ("Honey Crisp", 110.00, "Classic WOFLs"),
        # Chocolate WOFLs
        ("Choco Lava", 180.00, "Chocolate WOFLs"),
        ("Dark Chocolate Supreme", 200.00, "Chocolate WOFLs"),
        # Fruit WOFLs
        ("Strawberry Cream", 160.00, "Fruit WOFLs"),
        ("Mixed Berry Bliss", 170.00, "Fruit WOFLs"),
        # Premium Specials
    ...
    for product_name, price, category_name in products_data:
        ...
        product, created = Product.objects.get_or_create(
            Name=product_name,
            defaults={"Price": price, "ProductCategory": category, "Deleted": False},
        )
        if created:
