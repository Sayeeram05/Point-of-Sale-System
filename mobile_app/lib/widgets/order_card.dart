                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        // Order identifier and status - more flexible layout
                        Expanded(
                          flex: 2,
                          child: Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            ...
                            children: [
                              ...
                              if (order.customerName.isNotEmpty || order.paymentMethod.isNotEmpty)
                                Padding(
                                  padding: const EdgeInsets.only(left: 6, top: 2),
                                  child: Text(
                                    [
                                      if (order.customerName.isNotEmpty) order.customerName,
                                      if (order.paymentMethod.isNotEmpty) order.paymentMethod,
                                    ].join(' • '),
                                    style: TextStyle(
                                      fontSize: 10,
                                      color: order.completed
                            ...
                            onTap: () async {
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: Text(
                                    'Are you sure you want to delete $orderLabel?',
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
